<template>
  <div class="header-container">
    <lay @click.native="disappear"
         v-show="layShow"
         v-bind:msglay="msglay"></lay>
    <!-- 登录弹框 -->
    <login class="content_login"
           v-show="loginShow"
           v-bind:msglogin="msglogin"
        ...
        <div class="fr">
          <ul>
            ...
            <li class="pc-liver-center">
              ...
              <div class="pc-liver"
                   style="cursor: default;">{{$t('header.nav3_5')}}</div>
            ...
            <!-- 切换语言 -->
            <!-- <li style="width: 68px;height:17px;"
                class="language-choose">
              <a style="width: 68px;height: 22px;cursor: default;">{{useLanguage[0]}}</a>
              <div class="language">
                <div class="caret"></div>
                <div class="lan lan1">
                  <a @click="changeLanguageOne"
                     ref="lgOne"
                     href="#">{{useLanguage[1]}}</a>
                </div>
                <div class="lan language2">
                  <a class
                     @click="changeLanguageTwo"
                     ref="lgTwo"
                     href="#">{{useLanguage[2]}}</a>
                </div>
              </div>
            </li> -->
            <li v-show="!islogin"
            ...
            <li class="user"
                style="width: 48px;height: 48px;margin-top: 26px;border-radius: 50%;padding-right: 30px;"
                v-show="islogin">
              ...
              <div class="user_info">
                ...
                <div @click="gotoUserInfo"
                     class="user_info_recharge">
                  <a>我的主页</a>
                </div>
                <div @click="quit"
                     class="user_info_recharge user_info_quit">
                  <a>{{$t('header.me2')}}</a>
                </div>
              </div>
            </li>
  ...
  methods: {
    ...
    quhomeIndex () {
      if (this.islogin == true) {
        location.href = '../loginhome.html?id=' + this.user_id;
      } else {
    ...
    gotoUserInfo () {
      location.href = '../userinfo.html?id=' + cookie.default.getCookie("lespark_user_id");
    }
