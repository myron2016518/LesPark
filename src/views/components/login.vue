...
<template>
  <div>
    <div class="layer"
         @click="disappear(close)"
         v-bind:style="{height:screenHeight,width:screenWidth}"></div>
    <div class="login">
      <!-- 手机号码 -->
      <div class="login_this">
        <div class="mode">
          <p @click="denglu"
             v-bind:class="dengluShow==true?'choose':''">{{$t('login.nav1')}}</p>
          <p @click='reg'
             v-bind:class="regShow==true?'choose':''">{{$t('login.nav2')}}</p>
        </div>
        ...
        <div @keyup.enter="enter"
          ...
          <input v-model="log_phone"
                 class="this_log_phone"
                 type="text"
                 v-bind:placeholder="input1">
          <input v-model="log_password"
                 class="this_log_password"
                 type="password"
                 v-bind:placeholder="input2">
          <div @click="login"
               class="this_log_button">
      ...
      <div class="login_other">
        <div class="close"
             @click="disappear(close)"><img src="../images/close.png"></div>
        <p class="other"
           v-show='dengluShow'>{{$t('login.nav3_1')}}</p>
        <p class="other"
           v-show="regShow">{{$t('login.nav3_2')}}</p>
        <div class="other_mode">
          <ul>
            <li class="other_mode_ul_li"
                @click="otherLog(wx)"
                href=""><img src="../images/wx.png"></li>
            <li href=""
                @click="otherLog(qq)"><img src="../images/QQ_default.png"></li>
            <li class="other_mode_ul_li"
                @click="otherLog(xinlang)"
                href=""><img src="../images/xinlang.png"></li>
          </ul>
          <ul>
            <li class="other_mode_ul_li"
                @click="otherLog(facebook)"
                href=""><img src="../images/facebook.png"></li>
            <li class="other_mode_ul_li"
                @click="otherLog(ins)"
                href=""><img src="../images/ins.png"></li>
            <li class="other_mode_ul_li"
                @click="otherLog(line)"
                href=""><img src="../images/line.png"></li>
          </ul>
        </div>
      ...
      ajax.Post({
        ...
        if (ref.error == 0) {
          ...
          if (window.location.pathname.indexOf('index.html') !== -1) {
            location.href = '../userinfo.html?id=' + ref.data.user_id;
          } else {
            location.reload();
          }
        }
